...
parser.add_argument('--width', action='store', type=float, default=256, help='image width, along eta')
parser.add_argument('--height', action='store', type=float, default=256, help='image height, along phi')
...
def getImage(energy, bins): # bins: [x axin bin num, y axis bin num]
    ...
    xlim = [0, 256] # range at x axis
    ylim = [0, 256] # range at y axis
